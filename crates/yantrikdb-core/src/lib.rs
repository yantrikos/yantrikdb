...
pub use consolidate::{
    consolidate, find_consolidation_candidates, record_synthesis, summarize_cluster,
};
...
pub use engine::reextract::{
    ExtractionRefusalRow, ReextractReport, SilverRecallReport, REEXTRACT_EXTRACTORS,
};
