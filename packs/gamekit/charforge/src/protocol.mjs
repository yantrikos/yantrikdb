// The model-facing protocol: grammar prompt + STRICT validation.
// One definition serves the batch runner and the CLI — two copies
// would drift.
export const GRAMMAR = `You design characters for a 3D toy-like game engine by emitting a JSON spec.
